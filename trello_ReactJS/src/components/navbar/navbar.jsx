...
export function Navbar () {
    return (
        ...
        <div className="navbar-brand">
          <a className={classes['navbar-item']} href="https://trello.com/es"> 
        ...
        <div id="navbarBasicExample" className="navbar-menu">
          <div className="navbar-start">
            ...
            <a className={classes['navbar-item']} href="https://trello.com/templates">
                Templates
            </a>
      
            <div className={`${classes['navbar-item']} has-dropdown is-hoverable`} >
              <a className={classes['navbar-link']}>
                More
              </a>
      
              <div className="navbar-dropdown">
                <a className={classes['navbar-item']} href="https://trello.com/tour">
                  About
                </a>
                <hr className="navbar-divider"/>
                <a className={classes['navbar-item']} href="https://support.atlassian.com/trello/">
                  Report an issue
                </a>
              </div>
            </div>

            <a className={`${classes['navbar-item']} is-active`} >
              Create
            </a>
